...
static const std::string BRAKE_TEST_SERVICE_NAME{"brake_test_executor_node/execute_braketest"};
...
TEST(IntegrationtestTriggerBrakeTest, testBrakeTestService)
{
   ...
   **********/
  ros::NodeHandle nh;
  ros::ServiceClient brake_test_srv_client_ = nh.serviceClient<BrakeTest>(BRAKE_TEST_SERVICE_NAME);
